...
export const ui: { [lang: string]: UiLanguage } = {
  en: {
    ...
    "main.workExperience.descriptionMcde": "Development of web systems for municipal management with focus on geospatial visualization and administrative process optimization.",
    "main.workExperience.project1Mcde": "Street naming web system with interactive map for proposing and voting on street names.",
    "main.workExperience.project2Mcde": "Cadastral notification system with interactive map, enabling photographic land records, cadastral account visualization, and collaborative notification status tracking.",
    ...
    "main.workExperience.companyGeo": "Escuela San Roque",
    ...
    "main.workExperience.linkTextMoura": "Visit website",
    ...
    "main.aboutMe": `
      ...
      `,
    "main.aboutMe.imageAlt": "Photo of Adrian Portillo, software developer",
    "main.projects.imageAltXmenu": "Interactive online catalog to explore restaurant menus",
    "main.projects.imageAltQuickmock": "Quickmock tool interface for simulating user interfaces",
    "main.projects.codeButton": "Code",
    "main.projects.previewButton": "Preview",
    "main.workExperience.imageAltMcdeCatastro": "Cadastral notification system interface",
    "main.workExperience.imageAltMcdeVial": "Street naming web system interface",
    "main.workExperience.imageAltGeo": "GeoStory application interface",
    "main.workExperience.imageAltFdm": "Farmacia Divina Misericordia inventory management interface",
    "themeLight": "Light",
    "themeDark": "Dark",
    "themeSystem": "System",
    "theme.selectLabel": "Choose theme",
    "layout.title": "Adrian Portillo | Full-Stack Web Developer",
  ...
  es: {
    ...
    "main.workExperience.dateMcde": "Junio 2025 - Presente",
    "main.workExperience.titleMcde": "Desarrollador Fullstack",
    "main.workExperience.companyMcde": "Municipalidad de Ciudad del Este",
    "main.workExperience.descriptionMcde": "Desarrollo de sistemas web para gestión municipal con enfoque en visualización geoespacial y optimización de procesos administrativos.",
    "main.workExperience.project1Mcde": "Sistema web de nomenclatura vial con mapa interactivo para proponer y votar nombres de calles.",
    "main.workExperience.project2Mcde": "Sistema de notificación catastral con mapa interactivo, que permite registro fotográfico de terrenos, visualización de cuentas catastrales y seguimiento colaborativo del estado de notificaciones.",
    "main.workExperience.linkTextMcde": "Visitar sitio",
    "main.workExperience.linkGeo": "#",
    ...
    "main.workExperience.linkMoura": "https://www.jnmoura.com.br/",
    "main.workExperience.linkTextMoura": "Visitar sitio",
    ...
    "main.aboutMe": `
      ...
      `,
    "main.aboutMe.imageAlt": "Foto de Adrian Portillo, desarrollador de software",
    "main.projects.imageAltXmenu": "Catálogo online interactivo para explorar menús de restaurantes",
    "main.projects.imageAltQuickmock": "Interfaz de la herramienta Quickmock para simular interfaces de usuario",
    "main.projects.codeButton": "Código",
    "main.projects.previewButton": "Vista previa",
    "main.workExperience.imageAltMcdeCatastro": "Interfaz del sistema de notificación catastral",
    "main.workExperience.imageAltMcdeVial": "Interfaz del sistema web de nomenclatura vial",
    "main.workExperience.imageAltGeo": "Interfaz de la aplicación GeoStory",
    "main.workExperience.imageAltFdm": "Interfaz del sistema de gestión de inventario de Farmacia Divina Misericordia",
    "themeDark": "Oscuro",
    "themeLight": "Claro",
    "themeSystem": "Sistema",
    "theme.selectLabel": "Elige el tema",
    "layout.title": "Adrian Portillo | Desarrollador Web Full-Stack",
  ...
  pt: {
    ...
    "main.workExperience.descriptionMcde": "Desenvolvimento de sistemas web para gestão municipal com foco em visualização geoespacial e otimização de processos administrativos.",
    "main.workExperience.project1Mcde": "Sistema web de nomenclatura viária com mapa interativo para propor e votar nomes de ruas.",
    "main.workExperience.project2Mcde": "Sistema de notificação cadastral com mapa interativo, que permite registro fotográfico de terrenos, visualização de contas cadastrais e acompanhamento colaborativo do estado das notificações.",
    ...
    "main.workExperience.linkMoura": "https://www.jnmoura.com.br/",
    "main.workExperience.linkTextMoura": "Visitar site",
    "main.projects.titleXmenu": "Catálogo Online para Restaurantes",
    ...
    "main.aboutMe": `
      ...
      `,
    "main.aboutMe.imageAlt": "Foto de Adrian Portillo, desenvolvedor de software",
    "main.projects.imageAltXmenu": "Catálogo online interativo para explorar cardápios de restaurantes",
    "main.projects.imageAltQuickmock": "Interface da ferramenta Quickmock para simular interfaces de usuário",
    "main.projects.codeButton": "Código",
    "main.projects.previewButton": "Visualizar",
    "main.workExperience.imageAltMcdeCatastro": "Interface do sistema de notificação cadastral",
    "main.workExperience.imageAltMcdeVial": "Interface do sistema web de nomenclatura viária",
    "main.workExperience.imageAltGeo": "Interface da aplicação GeoStory",
    "main.workExperience.imageAltFdm": "Interface do sistema de gestão de inventário da Farmacia Divina Misericordia",
    "themeDark": "Escuro",
    "themeLight": "Claro",
    "themeSystem": "Sistema",
    "theme.selectLabel": "Escolher tema",
    "layout.title": "Adrian Portillo | Desenvolvedor Web Full-Stack",
